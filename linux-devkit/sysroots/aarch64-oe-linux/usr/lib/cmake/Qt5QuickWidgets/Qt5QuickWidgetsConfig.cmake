...
if (NOT TARGET Qt5::QuickWidgets)
    ...
    set(Qt5QuickWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickWidgets_install_prefix}/include/QtQuickWidgets/5.15.13"
        "${_qt5QuickWidgets_install_prefix}/include/QtQuickWidgets/5.15.13/QtQuickWidgets"
    )
    ...
    _populate_QuickWidgets_target_properties(RELEASE "libQt5QuickWidgets.so.5.15.13" "" FALSE)
    ...
    macro(_populate_QuickWidgets_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QuickWidgets_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickWidgets_check_file_exists(${imported_location})
