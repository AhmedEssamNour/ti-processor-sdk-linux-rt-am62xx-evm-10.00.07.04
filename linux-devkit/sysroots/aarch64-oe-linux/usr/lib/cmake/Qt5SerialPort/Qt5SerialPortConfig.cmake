...
if (NOT TARGET Qt5::SerialPort)
    ...
    set(Qt5SerialPort_PRIVATE_INCLUDE_DIRS
        "${_qt5SerialPort_install_prefix}/include/QtSerialPort/5.15.13"
        "${_qt5SerialPort_install_prefix}/include/QtSerialPort/5.15.13/QtSerialPort"
    )
    ...
    _populate_SerialPort_target_properties(RELEASE "libQt5SerialPort.so.5.15.13" "" FALSE)
    ...
    macro(_populate_SerialPort_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5SerialPort_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_SerialPort_check_file_exists(${imported_location})
