...
if (NOT TARGET Qt5::Widgets)
    ...
    set(Qt5Widgets_PRIVATE_INCLUDE_DIRS
        "${_qt5Widgets_install_prefix}/include/QtWidgets/5.15.13"
        "${_qt5Widgets_install_prefix}/include/QtWidgets/5.15.13/QtWidgets"
    )
    ...
    _populate_Widgets_target_properties(RELEASE "libQt5Widgets.so.5.15.13" "" FALSE)
    ...
    macro(_populate_Widgets_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Widgets_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Widgets_check_file_exists(${imported_location})
