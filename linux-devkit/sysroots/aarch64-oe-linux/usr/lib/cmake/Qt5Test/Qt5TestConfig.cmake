...
if (NOT TARGET Qt5::Test)
    ...
    set(Qt5Test_PRIVATE_INCLUDE_DIRS
        "${_qt5Test_install_prefix}/include/QtTest/5.15.13"
        "${_qt5Test_install_prefix}/include/QtTest/5.15.13/QtTest"
    )
    ...
    _populate_Test_target_properties(RELEASE "libQt5Test.so.5.15.13" "" FALSE)
    ...
    macro(_populate_Test_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Test_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Test_check_file_exists(${imported_location})
