...
if (NOT TARGET Qt5::QuickTest)
    ...
    set(Qt5QuickTest_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTest_install_prefix}/include/QtQuickTest/5.15.13"
        "${_qt5QuickTest_install_prefix}/include/QtQuickTest/5.15.13/QtQuickTest"
    )
    ...
    _populate_QuickTest_target_properties(RELEASE "libQt5QuickTest.so.5.15.13" "" FALSE)
    ...
    macro(_populate_QuickTest_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QuickTest_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickTest_check_file_exists(${imported_location})
