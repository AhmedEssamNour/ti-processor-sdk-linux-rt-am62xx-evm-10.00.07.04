...
if (NOT TARGET Qt5::Location)
    ...
    set(Qt5Location_PRIVATE_INCLUDE_DIRS
        "${_qt5Location_install_prefix}/include/QtLocation/5.15.13"
        "${_qt5Location_install_prefix}/include/QtLocation/5.15.13/QtLocation"
    )
    ...
    _populate_Location_target_properties(RELEASE "libQt5Location.so.5.15.13" "" FALSE)
    ...
    macro(_populate_Location_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Location_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Location_check_file_exists(${imported_location})
