...
if (NOT TARGET Qt5::DBus)
    ...
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/include/QtDBus/5.15.13"
        "${_qt5DBus_install_prefix}/include/QtDBus/5.15.13/QtDBus"
    )
    ...
    _populate_DBus_target_properties(RELEASE "libQt5DBus.so.5.15.13" "" FALSE)
    ...
    macro(_populate_DBus_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5DBus_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_DBus_check_file_exists(${imported_location})
