...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/QtCore/5.15.13"
        "${_qt5Core_install_prefix}/include/QtCore/5.15.13/QtCore"
    )
    ...
    set_property(TARGET Qt5::Core
                 ...
                 clock-gettime;datetimeparser;doubleconversion;futimens;getauxval;glibc;hijricalendar;icu;inotify;linkat;mimetype-database;system-pcre2;poll_ppoll;renameat2;sha3-fast;statx)
    set_property(TARGET Qt5::Core
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 etw;futimes;getentropy;glib;gnu-libiconv;iconv;journald;lttng;poll_poll;poll_pollts;poll_select;posix-libiconv;slog2;syslog;system-doubleconversion)
    ...
    _populate_Core_target_properties(RELEASE "libQt5Core.so.5.15.13" "" FALSE)
    ...
    macro(_populate_Core_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Core_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Core_check_file_exists(${imported_location})
