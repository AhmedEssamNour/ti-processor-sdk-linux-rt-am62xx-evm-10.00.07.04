...
if (NOT TARGET Qt5::Sql)
    ...
    set(Qt5Sql_PRIVATE_INCLUDE_DIRS
        "${_qt5Sql_install_prefix}/include/QtSql/5.15.13"
        "${_qt5Sql_install_prefix}/include/QtSql/5.15.13/QtSql"
    )
    ...
    _populate_Sql_target_properties(RELEASE "libQt5Sql.so.5.15.13" "" FALSE)
    ...
    macro(_populate_Sql_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Sql_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Sql_check_file_exists(${imported_location})
