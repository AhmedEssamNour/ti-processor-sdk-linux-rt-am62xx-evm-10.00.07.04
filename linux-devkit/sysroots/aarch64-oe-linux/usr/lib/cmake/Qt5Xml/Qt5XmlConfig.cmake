...
if (NOT TARGET Qt5::Xml)
    ...
    set(Qt5Xml_PRIVATE_INCLUDE_DIRS
        "${_qt5Xml_install_prefix}/include/QtXml/5.15.13"
        "${_qt5Xml_install_prefix}/include/QtXml/5.15.13/QtXml"
    )
    ...
    _populate_Xml_target_properties(RELEASE "libQt5Xml.so.5.15.13" "" FALSE)
    ...
    macro(_populate_Xml_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Xml_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Xml_check_file_exists(${imported_location})
