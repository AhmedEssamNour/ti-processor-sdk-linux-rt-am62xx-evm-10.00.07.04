...
if (NOT TARGET Qt5::OpenGL)
    ...
    set(Qt5OpenGL_PRIVATE_INCLUDE_DIRS
        "${_qt5OpenGL_install_prefix}/include/QtOpenGL/5.15.13"
        "${_qt5OpenGL_install_prefix}/include/QtOpenGL/5.15.13/QtOpenGL"
    )
    ...
    _populate_OpenGL_target_properties(RELEASE "libQt5OpenGL.so.5.15.13" "" FALSE)
    ...
    macro(_populate_OpenGL_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5OpenGL_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_OpenGL_check_file_exists(${imported_location})
