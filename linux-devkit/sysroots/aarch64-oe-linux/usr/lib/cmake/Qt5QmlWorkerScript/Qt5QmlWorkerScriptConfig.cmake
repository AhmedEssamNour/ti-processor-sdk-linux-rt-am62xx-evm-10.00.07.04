...
if (NOT TARGET Qt5::QmlWorkerScript)
    ...
    set(Qt5QmlWorkerScript_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlWorkerScript_install_prefix}/include/QtQmlWorkerScript/5.15.13"
        "${_qt5QmlWorkerScript_install_prefix}/include/QtQmlWorkerScript/5.15.13/QtQmlWorkerScript"
    )
    ...
    _populate_QmlWorkerScript_target_properties(RELEASE "libQt5QmlWorkerScript.so.5.15.13" "" FALSE)
    ...
    macro(_populate_QmlWorkerScript_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QmlWorkerScript_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_QmlWorkerScript_check_file_exists(${imported_location})
