...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/QtGui/5.15.13"
        "${_qt5Gui_install_prefix}/include/QtGui/5.15.13/QtGui"
    )
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 angle;combined-angle-lib;dynamicgl;openvg;sessionmanager;system-textmarkdownreader)
    set_property(TARGET Qt5::Gui
                 PROPERTY QT_ENABLED_PRIVATE_FEATURES
                 drm_atomic;egl;eglfs;kms;eglfs_egldevice;eglfs_gbm;evdev;freetype;system-freetype;fontconfig;gif;harfbuzz;imageio-text-loading;jpeg;libinput;libinput-axis-api;linuxfb;multiprocess;png;raster-64bit;system-jpeg;system-png;tuiotouch;vkgen;vnc;xkbcommon)
    set_property(TARGET Qt5::Gui
    ...
    _populate_Gui_target_properties(RELEASE "libQt5Gui.so.5.15.13" "" FALSE)
