...
if (NOT TARGET Qt5::QmlModels)
    ...
    set(Qt5QmlModels_PRIVATE_INCLUDE_DIRS
        "${_qt5QmlModels_install_prefix}/include/QtQmlModels/5.15.13"
        "${_qt5QmlModels_install_prefix}/include/QtQmlModels/5.15.13/QtQmlModels"
    )
    ...
    _populate_QmlModels_target_properties(RELEASE "libQt5QmlModels.so.5.15.13" "" FALSE)
    ...
    macro(_populate_QmlModels_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QmlModels_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_QmlModels_check_file_exists(${imported_location})
