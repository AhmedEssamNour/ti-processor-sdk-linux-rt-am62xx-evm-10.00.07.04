...
if (NOT TARGET Qt5::Network)
    ...
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/include/QtNetwork/5.15.13"
        "${_qt5Network_install_prefix}/include/QtNetwork/5.15.13/QtNetwork"
    )
    ...
    _populate_Network_target_properties(RELEASE "libQt5Network.so.5.15.13" "" FALSE)
