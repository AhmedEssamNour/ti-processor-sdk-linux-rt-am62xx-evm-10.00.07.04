...
if (NOT TARGET Qt5::Quick)
    ...
    set(Qt5Quick_PRIVATE_INCLUDE_DIRS
        "${_qt5Quick_install_prefix}/include/QtQuick/5.15.13"
        "${_qt5Quick_install_prefix}/include/QtQuick/5.15.13/QtQuick"
    )
    ...
    _populate_Quick_target_properties(RELEASE "libQt5Quick.so.5.15.13" "" FALSE)
    ...
    macro(_populate_Quick_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Quick_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Quick_check_file_exists(${imported_location})
