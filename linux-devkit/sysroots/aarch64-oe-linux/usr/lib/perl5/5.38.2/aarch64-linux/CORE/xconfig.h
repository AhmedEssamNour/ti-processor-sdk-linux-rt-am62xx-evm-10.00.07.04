 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PERL_VENDORARCH "/usr/lib/perl5/vendor_perl/5.38.2/aarch64-linux"		/**/
#define PERL_VENDORARCH_EXP "/usr/lib/perl5/vendor_perl/5.38.2/aarch64-linux"		/**/
 ...
 *	be tacked onto this variable to generate a list of directories to search.
 */
#define PERL_VENDORLIB_EXP "/usr/lib/perl5/vendor_perl/5.38.2"		/**/
